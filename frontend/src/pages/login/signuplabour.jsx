            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  type="text"
                  required
                  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2  sm:text-lg lg:leading-6"
                />
              </div>
            </div>
            <div>
